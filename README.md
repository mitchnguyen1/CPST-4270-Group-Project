...
7. Compile the project with the PostgreSQL driver on the classpath by running this command:
   Mac: javac -cp ".:lib/postgresql-42.x.x.jar" *.java
   Windows: javac -cp ".;lib\postgresql-42.x.x.jar" *.java
8. Run the ATM program, making sure to include the PostgreSQL jar on the classpath:
